...
AUTO_GENERATED_COMMENT = "# Auto-generated by radiolib."
'''
 === 
 CONSTANTS
 ====
...
def create_atlas(images: list, atlas_size: tuple, rows_and_columns: tuple):
    ...
    # Add at least 1px of padding to the last emote in the row
    padding = 1

    rows, cols = rows_and_columns
    img_width, img_height = images[0].size

    new_width = (img_width * cols) + padding
    new_height = (img_height * rows)
    atlas = Image.new("RGBA", (new_width, new_height), (255, 255, 255, 0))
    ...
    for i, img in enumerate(images):
        ...
        print(f'COL: {column} ROW : {row}\t X: {x_pos} Y: {y_pos}')
...
def contains_punctuation(s: str):
    import string
    for char in s:
...
def validaite_emote_name(emote_name: str):
    ...
    if(contains_punctuation(emote_name)):
        print(f"'{emote_name} has some invalid characters, skipping")
        return False
